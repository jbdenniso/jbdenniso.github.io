...
![Conceptual Figure]({{ site.baseurl }}/images/_post2/Concept_Figure.png)
...
![Bayesian Graph]({{ site.baseurl }}/images/_post2/image4.png)

We run MCMC and see thatwe are able to recover both the phi parameters and the different beta distributions.

![parameter recovery]({{ site.baseurl }}/images/_post2/Figure2_recover.png)
